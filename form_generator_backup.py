...
class FormGenerator:
    ...
    def add_ac_specific_section(self, form_id: str, ac_number: str, ac_data: Dict[str, List[str]], 
        ...
        requests.append({
            "createItem": {
                "item": {
                    "title": f"{ac_questions['q1']['english']}\n{ac_questions['q1']['bengali']}",
                    "choiceQuestion": {
                        "type": "RADIO",
                        "options": q1_options,
                        "shuffle": False
        ...
        requests.append({
            "createItem": {
                "item": {
                    "title": f"{ac_questions['q2']['english']}\n{ac_questions['q2']['bengali']}",
                    "choiceQuestion": {
                        "type": "RADIO",
                        "options": q2_options,
                        "shuffle": False
        ...
        requests.append({
            "createItem": {
                "item": {
                    "title": f"{ac_questions['q3']['english']}\n{ac_questions['q3']['bengali']}",
                    "choiceQuestion": {
                        "type": "RADIO",
                        "options": q3_options,
                        "shuffle": False
        ...
        requests.append({
            "createItem": {
                "item": {
                    "title": f"{ac_questions['q4']['english']}\n{ac_questions['q4']['bengali']}",
                    "choiceQuestion": {
                        "type": "RADIO",
                        "options": q4_options,
                        "shuffle": False
        ...
        requests.append({
            "createItem": {
                "item": {
                    "title": f"{ac_questions['q5']['english']}\n{ac_questions['q5']['bengali']}",
                    "choiceQuestion": {
                        "type": "RADIO",
                        "options": q5_options,
                        "shuffle": False
        ...
        requests.append({
            "createItem": {
                "item": {
                    "title": f"{ac_questions['q6']['english']}\n{ac_questions['q6']['bengali']}",
                    "choiceQuestion": {
                        "type": "RADIO",
                        "options": q6_options,
                        "shuffle": False
    ...
    def add_final_section(self, form_id: str, start_index: int) -> List[str]:
        ...
        requests.append({
            "createItem": {
                "item": {
                    "title": f"{final_questions['q7']['english']}\n{final_questions['q7']['bengali']}",
                    "choiceQuestion": {
                        "type": "RADIO",
                        "options": q7_options,
                        "shuffle": False
        ...
        requests.append({
            "createItem": {
                "item": {
                    "title": f"{final_questions['q8']['english']}\n{final_questions['q8']['bengali']}",
                    "choiceQuestion": {
                        "type": "RADIO",
                        "options": q8_options,
                        "shuffle": False
